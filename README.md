...
<video src="docs/parsify.mp4" width="100%" controls></video>

*If the video player doesn't load, you can access the file directly: [docs/parsify.mp4](docs/parsify.mp4)*
